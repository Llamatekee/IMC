...
void commonFunction(int l, int h, float e, float m, int f, bool s, bool n, const std::string& command){
    ...
    system(("echo '   l = " + std::to_string(l) +
            ...
            ", f = " + std::to_string(f) +
            ", s = " + (s ? "true" : "false") +
            ", n = " + (n ? "true" : "false") + "' >> ./results3.out").c_str());

    auto start_time = std::chrono::high_resolution_clock::now();

    // Sustituir el comando específico por la variable 'command'
    system((command + " | tail -n 4 >> ./results3.out").c_str());
...
int main() {
    ...
    system("echo 'EXPERIMENT 2' >> ./results3.out");
    ...
    commonFunction(2, 4, 0.7, 1.0, 0, false, false, "../../la2 -t ../../datasetsLA2IMC/dat/train_compas.dat -T ../../datasetsLA2IMC/dat/test_compas.dat -i 1000 -l 2 -h 4 -e 0.7 -m 1.0 -f 0 -o");
    ...
    commonFunction(2, 16, 0.7, 1.0, 0, true, false, "../../la2 -t ../../datasetsLA2IMC/dat/train_nomnist.dat -T ../../datasetsLA2IMC/dat/test_nomnist.dat -i 1000 -l 2 -h 16 -e 0.7 -m 1.0 -f 0 -s -o");
